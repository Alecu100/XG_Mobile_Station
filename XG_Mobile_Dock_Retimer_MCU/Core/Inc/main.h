...
/* Private defines -----------------------------------------------------------*/
#define LOCK_SW_Pin GPIO_PIN_4
#define LOCK_SW_GPIO_Port GPIOC
#define LOCK_SW_EXTI_IRQn EXTI4_IRQn
...
#define CON_DET_EXTI_IRQn EXTI0_IRQn
#define PWREN_Pin GPIO_PIN_1
#define PWREN_GPIO_Port GPIOA
#define PWREN_EXTI_IRQn EXTI1_IRQn
#define RST_Pin GPIO_PIN_2
#define RST_GPIO_Port GPIOA
#define RST_EXTI_IRQn EXTI2_IRQn
...
#define FAN_ON_Pin GPIO_PIN_8
#define FAN_ON_GPIO_Port GPIOA
#define CASE_LED_Pin GPIO_PIN_8
#define CASE_LED_GPIO_Port GPIOC
#define PCI_12V_EN_Pin GPIO_PIN_6
...
#define RETIMER_PERST_Pin GPIO_PIN_0
#define RETIMER_PERST_GPIO_Port GPIOC
#define RETIMER_CLKREQ_Pin GPIO_PIN_1
#define RETIMER_CLKREQ_GPIO_Port GPIOC
#define BUCK_ON_Pin GPIO_PIN_3
#define BUCK_ON_GPIO_Port GPIOC
#define PGOOD_BUCK_Pin GPIO_PIN_12
#define PGOOD_BUCK_GPIO_Port GPIOB

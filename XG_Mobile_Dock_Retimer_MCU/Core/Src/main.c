...
int main(void)
{
  ...
  MX_TIM6_Init();
  /* USER CODE BEGIN 2 */
  /* Enable the USART3 interrupt for the non-blocking ring-buffer logger (see
...
/* USER CODE END MX_GPIO_Init_1 */
  ...
  /* Hold the retimer in reset and keep its core buck disabled at boot. */
  HAL_GPIO_WritePin(GPIOC, RETIMER_PERST_Pin, GPIO_PIN_SET);
  HAL_GPIO_WritePin(GPIOC, RETIMER_CLKREQ_Pin|BUCK_ON_Pin, GPIO_PIN_RESET);
  ...
  /* Host CLKREQ# is sampled and mirrored to the retimer's dedicated pin. */
  GPIO_InitStruct.Pin = CLKREQ_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_INPUT;
  GPIO_InitStruct.Pull = GPIO_PULLUP;
  HAL_GPIO_Init(CLKREQ_GPIO_Port, &GPIO_InitStruct);
  ...
  /* Retimer reset drives an inverting transistor: high asserts PERST#. */
  GPIO_InitStruct.Pin = RETIMER_PERST_Pin|BUCK_ON_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  HAL_GPIO_Init(GPIOC, &GPIO_InitStruct);

  GPIO_InitStruct.Pin = RETIMER_CLKREQ_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_OD;
  GPIO_InitStruct.Pull = GPIO_PULLUP;
  HAL_GPIO_Init(GPIOC, &GPIO_InitStruct);

  GPIO_InitStruct.Pin = PGOOD_BUCK_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_INPUT;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  HAL_GPIO_Init(PGOOD_BUCK_GPIO_Port, &GPIO_InitStruct);

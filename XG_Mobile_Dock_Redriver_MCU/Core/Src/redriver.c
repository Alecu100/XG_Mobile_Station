...
static void initialize_gpu_cpu_redriver_running()
{
    ...
    initialize_channel_eq(GPU_CPU_0_3_ADDR_I2C, CHANNEL_0_REGISTER, 0 | EQ_CONTROL_EQ_STAGE2_INDEX_0 | EQ_CONTROL_EQ_STAGE1_BYPASS);
    initialize_channel_eq(GPU_CPU_0_3_ADDR_I2C, CHANNEL_1_REGISTER, 0 | EQ_CONTROL_EQ_STAGE2_INDEX_0 | EQ_CONTROL_EQ_STAGE1_BYPASS);
    initialize_channel_eq(GPU_CPU_0_3_ADDR_I2C, CHANNEL_2_REGISTER, 0 | EQ_CONTROL_EQ_STAGE2_INDEX_0 | EQ_CONTROL_EQ_STAGE1_BYPASS);
    initialize_channel_eq(GPU_CPU_0_3_ADDR_I2C, CHANNEL_3_REGISTER, 0 | EQ_CONTROL_EQ_STAGE2_INDEX_0 | EQ_CONTROL_EQ_STAGE1_BYPASS);
    initialize_channel_eq(GPU_CPU_4_7_ADDR_I2C, CHANNEL_4_REGISTER, 0 | EQ_CONTROL_EQ_STAGE2_INDEX_0 | EQ_CONTROL_EQ_STAGE1_BYPASS);
    initialize_channel_eq(GPU_CPU_4_7_ADDR_I2C, CHANNEL_5_REGISTER, 0 | EQ_CONTROL_EQ_STAGE2_INDEX_0 | EQ_CONTROL_EQ_STAGE1_BYPASS);
    initialize_channel_eq(GPU_CPU_4_7_ADDR_I2C, CHANNEL_6_REGISTER, 0 | EQ_CONTROL_EQ_STAGE2_INDEX_0 | EQ_CONTROL_EQ_STAGE1_BYPASS);
    initialize_channel_eq(GPU_CPU_4_7_ADDR_I2C, CHANNEL_7_REGISTER, 0 | EQ_CONTROL_EQ_STAGE2_INDEX_0 | EQ_CONTROL_EQ_STAGE1_BYPASS);

...
#define EQ_CONTROL_EQ_STAGE1_INDEX_0 (0 << 3)
#define EQ_CONTROL_EQ_STAGE1_INDEX_1 (1 << 3)
#define EQ_CONTROL_EQ_STAGE1_INDEX_2 (3 << 3)
#define EQ_CONTROL_EQ_STAGE1_INDEX_5 (0 << 3)
#define EQ_CONTROL_EQ_STAGE1_INDEX_6 (1 << 3)
#define EQ_CONTROL_EQ_STAGE1_INDEX_7 (2 << 3)
#define EQ_CONTROL_EQ_STAGE1_INDEX_8 (3 << 3)
#define EQ_CONTROL_EQ_STAGE1_INDEX_9 (4 << 3)
#define EQ_CONTROL_EQ_STAGE1_INDEX_10 (5 << 3)
#define EQ_CONTROL_EQ_STAGE1_INDEX_11 (6 << 3)
#define EQ_CONTROL_EQ_STAGE1_INDEX_12 (8 << 3)
#define EQ_CONTROL_EQ_STAGE1_INDEX_13 (10 << 3)
#define EQ_CONTROL_EQ_STAGE1_INDEX_14 (10 << 3)
#define EQ_CONTROL_EQ_STAGE1_INDEX_15 (11 << 3)
#define EQ_CONTROL_EQ_STAGE1_INDEX_16 (12 << 3)
#define EQ_CONTROL_EQ_STAGE1_INDEX_17 (13 << 3)
#define EQ_CONTROL_EQ_STAGE1_INDEX_18 (14 << 3)
#define EQ_CONTROL_EQ_STAGE1_INDEX_19 (15 << 3)
...
#define EQ_CONTROL_EQ_STAGE2_INDEX_10 1
#define EQ_CONTROL_EQ_STAGE2_INDEX_11 1
#define EQ_CONTROL_EQ_STAGE2_INDEX_12 1
#define EQ_CONTROL_EQ_STAGE2_INDEX_13 1
#define EQ_CONTROL_EQ_STAGE2_INDEX_14 2
#define EQ_CONTROL_EQ_STAGE2_INDEX_15 3
#define EQ_CONTROL_EQ_STAGE2_INDEX_16 4
#define EQ_CONTROL_EQ_STAGE2_INDEX_17 5
#define EQ_CONTROL_EQ_STAGE2_INDEX_18 6
#define EQ_CONTROL_EQ_STAGE2_INDEX_19 7
...
static void initialize_gpu_cpu_redriver_boot()
{
    ...
    initialize_channel_eq_profile(GPU_CPU_0_3_ADDR_I2C, CHANNEL_0_REGISTER, EQ_PROFILE_INDEX_19 | FLAT_GAIN_0 | FLAT_GAIN_2);
    initialize_channel_eq_profile(GPU_CPU_0_3_ADDR_I2C, CHANNEL_1_REGISTER, EQ_PROFILE_INDEX_19 | FLAT_GAIN_0 | FLAT_GAIN_2);
    initialize_channel_eq_profile(GPU_CPU_0_3_ADDR_I2C, CHANNEL_2_REGISTER, EQ_PROFILE_INDEX_19 | FLAT_GAIN_0 | FLAT_GAIN_2);
    initialize_channel_eq_profile(GPU_CPU_0_3_ADDR_I2C, CHANNEL_3_REGISTER, EQ_PROFILE_INDEX_19 | FLAT_GAIN_0 | FLAT_GAIN_2);
    initialize_channel_eq_profile(GPU_CPU_4_7_ADDR_I2C, CHANNEL_4_REGISTER, EQ_PROFILE_INDEX_19 | FLAT_GAIN_0 | FLAT_GAIN_2);
    initialize_channel_eq_profile(GPU_CPU_4_7_ADDR_I2C, CHANNEL_5_REGISTER, EQ_PROFILE_INDEX_19 | FLAT_GAIN_0 | FLAT_GAIN_2);
    initialize_channel_eq_profile(GPU_CPU_4_7_ADDR_I2C, CHANNEL_6_REGISTER, EQ_PROFILE_INDEX_19 | FLAT_GAIN_0 | FLAT_GAIN_2);
    initialize_channel_eq_profile(GPU_CPU_4_7_ADDR_I2C, CHANNEL_7_REGISTER, EQ_PROFILE_INDEX_19 | FLAT_GAIN_0 | FLAT_GAIN_2);
}
...
static void initialize_gpu_cpu_redriver_running()
{
    ...
    initialize_channel_eq(GPU_CPU_0_3_ADDR_I2C, CHANNEL_0_REGISTER, EQ_CONTROL_EQ_STAGE1_INDEX_0 | EQ_CONTROL_EQ_STAGE2_INDEX_0 | EQ_STAGE_1_BYPASS_INDEX_2);
    initialize_channel_eq(GPU_CPU_0_3_ADDR_I2C, CHANNEL_1_REGISTER, EQ_CONTROL_EQ_STAGE1_INDEX_0 | EQ_CONTROL_EQ_STAGE2_INDEX_0 | EQ_STAGE_1_BYPASS_INDEX_2);
    initialize_channel_eq(GPU_CPU_0_3_ADDR_I2C, CHANNEL_2_REGISTER, EQ_CONTROL_EQ_STAGE1_INDEX_0 | EQ_CONTROL_EQ_STAGE2_INDEX_0 | EQ_STAGE_1_BYPASS_INDEX_2);
    initialize_channel_eq(GPU_CPU_0_3_ADDR_I2C, CHANNEL_3_REGISTER, EQ_CONTROL_EQ_STAGE1_INDEX_0 | EQ_CONTROL_EQ_STAGE2_INDEX_0 | EQ_STAGE_1_BYPASS_INDEX_2);
    initialize_channel_eq(GPU_CPU_4_7_ADDR_I2C, CHANNEL_4_REGISTER, EQ_CONTROL_EQ_STAGE1_INDEX_0 | EQ_CONTROL_EQ_STAGE2_INDEX_0 | EQ_STAGE_1_BYPASS_INDEX_2);
    initialize_channel_eq(GPU_CPU_4_7_ADDR_I2C, CHANNEL_5_REGISTER, EQ_CONTROL_EQ_STAGE1_INDEX_0 | EQ_CONTROL_EQ_STAGE2_INDEX_0 | EQ_STAGE_1_BYPASS_INDEX_2);
    initialize_channel_eq(GPU_CPU_4_7_ADDR_I2C, CHANNEL_6_REGISTER, EQ_CONTROL_EQ_STAGE1_INDEX_0 | EQ_CONTROL_EQ_STAGE2_INDEX_0 | EQ_STAGE_1_BYPASS_INDEX_2);
    initialize_channel_eq(GPU_CPU_4_7_ADDR_I2C, CHANNEL_7_REGISTER, EQ_CONTROL_EQ_STAGE1_INDEX_0 | EQ_CONTROL_EQ_STAGE2_INDEX_0 | EQ_STAGE_1_BYPASS_INDEX_2);

    // Bias 111 (max) is used here, not the datasheet-recommended 001. Empirically it
    // gives the most stable GPU->CPU link over the XG Mobile cable (high post-channel
    // loss + 2x redriver cascade). Do not "correct" this back to 001.
    initialize_channel_bias(GPU_CPU_0_3_ADDR_I2C, CHANNEL_0_REGISTER, BIAS_CURRENT_0 | BIAS_CURRENT_1 | BIAS_CURRENT_2);
    initialize_channel_bias(GPU_CPU_0_3_ADDR_I2C, CHANNEL_1_REGISTER, BIAS_CURRENT_0 | BIAS_CURRENT_1 | BIAS_CURRENT_2);
    initialize_channel_bias(GPU_CPU_0_3_ADDR_I2C, CHANNEL_2_REGISTER, BIAS_CURRENT_0 | BIAS_CURRENT_1 | BIAS_CURRENT_2);
    initialize_channel_bias(GPU_CPU_0_3_ADDR_I2C, CHANNEL_3_REGISTER, BIAS_CURRENT_0 | BIAS_CURRENT_1 | BIAS_CURRENT_2);
    initialize_channel_bias(GPU_CPU_4_7_ADDR_I2C, CHANNEL_4_REGISTER, BIAS_CURRENT_0 | BIAS_CURRENT_1 | BIAS_CURRENT_2);
    initialize_channel_bias(GPU_CPU_4_7_ADDR_I2C, CHANNEL_5_REGISTER, BIAS_CURRENT_0 | BIAS_CURRENT_1 | BIAS_CURRENT_2);
    initialize_channel_bias(GPU_CPU_4_7_ADDR_I2C, CHANNEL_6_REGISTER, BIAS_CURRENT_0 | BIAS_CURRENT_1 | BIAS_CURRENT_2);
    initialize_channel_bias(GPU_CPU_4_7_ADDR_I2C, CHANNEL_7_REGISTER, BIAS_CURRENT_0 | BIAS_CURRENT_1 | BIAS_CURRENT_2);

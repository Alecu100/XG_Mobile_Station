...
static void initialize_cpu_gpu_redriver()
{
    ...
    initialize_channel_eq(CPU_GPU_0_3_ADDR_I2C, CHANNEL_3_REGISTER, EQ_CONTROL_EQ_STAGE1_INDEX_6 | EQ_CONTROL_EQ_STAGE2_INDEX_12);
    ...
    initialize_channel_eq_profile(CPU_GPU_0_3_ADDR_I2C, CHANNEL_3_REGISTER, EQ_PROFILE_INDEX_10 | FLAT_GAIN_0 | FLAT_GAIN_1 | FLAT_GAIN_2);

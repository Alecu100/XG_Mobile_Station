...
static void initialize_gpu_cpu_redriver()
{
    ...
    initialize_channel_eq_profile(GPU_CPU_0_3_ADDR_I2C, CHANNEL_0_REGISTER, EQ_PROFILE_0 | EQ_PROFILE_1 | EQ_PROFILE_2 | FLAT_GAIN_0 | FLAT_GAIN_2);
    ...
    initialize_channel_eq_profile(GPU_CPU_0_3_ADDR_I2C, CHANNEL_2_REGISTER, EQ_PROFILE_0 | EQ_PROFILE_1 | EQ_PROFILE_2 | FLAT_GAIN_0 | FLAT_GAIN_2);
    initialize_channel_eq_profile(GPU_CPU_0_3_ADDR_I2C, CHANNEL_3_REGISTER, EQ_PROFILE_0 | EQ_PROFILE_1 | EQ_PROFILE_2 | FLAT_GAIN_0 | FLAT_GAIN_2);

...
static void initialize_cpu_gpu_redriver()
{
    ...
    initialize_channel_eq(CPU_GPU_0_3_ADDR_I2C, CHANNEL_0_REGISTER, EQ_CONTROL_EQ_STAGE1_INDEX_6 | EQ_CONTROL_EQ_STAGE2_INDEX_12);
    initialize_channel_eq(CPU_GPU_0_3_ADDR_I2C, CHANNEL_1_REGISTER, EQ_CONTROL_EQ_STAGE1_INDEX_6 | EQ_CONTROL_EQ_STAGE2_INDEX_12);
    initialize_channel_eq(CPU_GPU_0_3_ADDR_I2C, CHANNEL_2_REGISTER, EQ_CONTROL_EQ_STAGE1_INDEX_5 | EQ_CONTROL_EQ_STAGE2_INDEX_11);
    initialize_channel_eq(CPU_GPU_0_3_ADDR_I2C, CHANNEL_3_REGISTER, EQ_CONTROL_EQ_STAGE1_INDEX_6 | EQ_CONTROL_EQ_STAGE2_INDEX_13);
    initialize_channel_eq(CPU_GPU_4_7_ADDR_I2C, CHANNEL_4_REGISTER, EQ_CONTROL_EQ_STAGE1_INDEX_6 | EQ_CONTROL_EQ_STAGE2_INDEX_13);
    initialize_channel_eq(CPU_GPU_4_7_ADDR_I2C, CHANNEL_5_REGISTER, EQ_CONTROL_EQ_STAGE1_INDEX_8 | EQ_CONTROL_EQ_STAGE2_INDEX_12);
    initialize_channel_eq(CPU_GPU_4_7_ADDR_I2C, CHANNEL_6_REGISTER, EQ_CONTROL_EQ_STAGE1_INDEX_5 | EQ_CONTROL_EQ_STAGE2_INDEX_10);
    initialize_channel_eq(CPU_GPU_4_7_ADDR_I2C, CHANNEL_7_REGISTER, EQ_CONTROL_EQ_STAGE1_INDEX_6 | EQ_CONTROL_EQ_STAGE2_INDEX_13);
    ...
    initialize_channel_eq_profile(CPU_GPU_4_7_ADDR_I2C, CHANNEL_5_REGISTER, EQ_PROFILE_INDEX_10 | FLAT_GAIN_0 | FLAT_GAIN_1 | FLAT_GAIN_2);

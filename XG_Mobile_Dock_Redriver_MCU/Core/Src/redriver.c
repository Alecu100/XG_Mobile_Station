...
static ramp_channel_t ramp_channels[] = {
    ...
    { GPU_CPU_4_7_ADDR_I2C, CHANNEL_4_REGISTER, CHANNEL_ENABLED, EQ_LEVEL_19,  EQ_LEVEL_0, FLAT_GAIN_LEVEL_5, FLAT_GAIN_LEVEL_0, BIAS_LEVEL_1, BIAS_LEVEL_7, RAMP_STEP_MS, 4 * RAMP_STAGGER_MS },
    { GPU_CPU_4_7_ADDR_I2C, CHANNEL_5_REGISTER, CHANNEL_ENABLED, EQ_LEVEL_19,  EQ_LEVEL_0, FLAT_GAIN_LEVEL_5, FLAT_GAIN_LEVEL_0, BIAS_LEVEL_1, BIAS_LEVEL_7, RAMP_STEP_MS, 5 * RAMP_STAGGER_MS },
    { GPU_CPU_4_7_ADDR_I2C, CHANNEL_6_REGISTER, CHANNEL_ENABLED, EQ_LEVEL_0,  EQ_LEVEL_0, FLAT_GAIN_LEVEL_5, FLAT_GAIN_LEVEL_0, BIAS_LEVEL_1, BIAS_LEVEL_3, RAMP_STEP_MS, 7 * RAMP_STAGGER_MS },
    { GPU_CPU_4_7_ADDR_I2C, CHANNEL_7_REGISTER, CHANNEL_ENABLED, EQ_LEVEL_19,  EQ_LEVEL_0, FLAT_GAIN_LEVEL_5, FLAT_GAIN_LEVEL_0, BIAS_LEVEL_1, BIAS_LEVEL_7, RAMP_STEP_MS, 6 * RAMP_STAGGER_MS },

...
static void initialize_gpu_cpu_redriver()
{
    ...
    initialize_channel_eq(GPU_CPU_0_3_ADDR_I2C, CHANNEL_0_REGISTER, EQ_CONTROL_EQ_STAGE1_3 | EQ_CONTROL_EQ_STAGE1_1 | EQ_CONTROL_EQ_STAGE2_0);
    initialize_channel_eq(GPU_CPU_0_3_ADDR_I2C, CHANNEL_1_REGISTER, EQ_CONTROL_EQ_STAGE1_3 | EQ_CONTROL_EQ_STAGE1_1 | EQ_CONTROL_EQ_STAGE2_0);
    initialize_channel_eq(GPU_CPU_0_3_ADDR_I2C, CHANNEL_2_REGISTER, EQ_CONTROL_EQ_STAGE1_3 | EQ_CONTROL_EQ_STAGE1_1 | EQ_CONTROL_EQ_STAGE2_0);
    initialize_channel_eq(GPU_CPU_0_3_ADDR_I2C, CHANNEL_3_REGISTER, EQ_CONTROL_EQ_STAGE1_3 | EQ_CONTROL_EQ_STAGE1_1 | EQ_CONTROL_EQ_STAGE2_0);
    initialize_channel_eq(GPU_CPU_4_7_ADDR_I2C, CHANNEL_4_REGISTER, EQ_CONTROL_EQ_STAGE1_3 | EQ_CONTROL_EQ_STAGE1_1 | EQ_CONTROL_EQ_STAGE1_2 | EQ_CONTROL_EQ_STAGE2_2);
    initialize_channel_eq(GPU_CPU_4_7_ADDR_I2C, CHANNEL_5_REGISTER, EQ_CONTROL_EQ_STAGE1_3 | EQ_CONTROL_EQ_STAGE1_1 | EQ_CONTROL_EQ_STAGE1_2 | EQ_CONTROL_EQ_STAGE1_3 | EQ_CONTROL_EQ_STAGE2_1 | EQ_CONTROL_EQ_STAGE2_2 | EQ_CONTROL_EQ_STAGE2_0);
    initialize_channel_eq(GPU_CPU_4_7_ADDR_I2C, CHANNEL_6_REGISTER, EQ_CONTROL_EQ_STAGE1_3 | EQ_CONTROL_EQ_STAGE1_1 | EQ_CONTROL_EQ_STAGE1_2 | EQ_CONTROL_EQ_STAGE1_3 | EQ_CONTROL_EQ_STAGE1_0 | EQ_CONTROL_EQ_STAGE2_1 | EQ_CONTROL_EQ_STAGE2_2 | EQ_CONTROL_EQ_STAGE2_0);
    initialize_channel_eq(GPU_CPU_4_7_ADDR_I2C, CHANNEL_7_REGISTER, EQ_CONTROL_EQ_STAGE1_3 | EQ_CONTROL_EQ_STAGE1_1 | EQ_CONTROL_EQ_STAGE1_2 | EQ_CONTROL_EQ_STAGE2_2);
    ...
    initialize_channel_eq_profile(GPU_CPU_0_3_ADDR_I2C, CHANNEL_0_REGISTER, EQ_PROFILE_0 | EQ_PROFILE_1 | EQ_PROFILE_2 | FLAT_GAIN_0);
    initialize_channel_eq_profile(GPU_CPU_0_3_ADDR_I2C, CHANNEL_1_REGISTER, EQ_PROFILE_0 | EQ_PROFILE_1 | EQ_PROFILE_2 | FLAT_GAIN_0 | FLAT_GAIN_2);
    initialize_channel_eq_profile(GPU_CPU_0_3_ADDR_I2C, CHANNEL_2_REGISTER, EQ_PROFILE_0 | EQ_PROFILE_1 | EQ_PROFILE_2 | FLAT_GAIN_0 | FLAT_GAIN_1);
    initialize_channel_eq_profile(GPU_CPU_0_3_ADDR_I2C, CHANNEL_3_REGISTER, EQ_PROFILE_0 | EQ_PROFILE_1 | EQ_PROFILE_2 | FLAT_GAIN_0 | FLAT_GAIN_1);
    initialize_channel_eq_profile(GPU_CPU_4_7_ADDR_I2C, CHANNEL_4_REGISTER, EQ_PROFILE_0 | EQ_PROFILE_1 | EQ_PROFILE_2 | EQ_PROFILE_3 | FLAT_GAIN_0);
    initialize_channel_eq_profile(GPU_CPU_4_7_ADDR_I2C, CHANNEL_5_REGISTER, EQ_PROFILE_0 | EQ_PROFILE_1 | EQ_PROFILE_2 | EQ_PROFILE_3);
    initialize_channel_eq_profile(GPU_CPU_4_7_ADDR_I2C, CHANNEL_6_REGISTER, EQ_PROFILE_0 | EQ_PROFILE_1 | EQ_PROFILE_2 | EQ_PROFILE_3);
    initialize_channel_eq_profile(GPU_CPU_4_7_ADDR_I2C, CHANNEL_7_REGISTER, EQ_PROFILE_0 | EQ_PROFILE_1 | EQ_PROFILE_2 | EQ_PROFILE_3);
}

static void initialize_cpu_gpu_redriver()
{
    initialize_channel_eq(CPU_GPU_0_3_ADDR_I2C, CHANNEL_0_REGISTER, EQ_CONTROL_EQ_STAGE1_2);
    initialize_channel_eq(CPU_GPU_0_3_ADDR_I2C, CHANNEL_1_REGISTER, EQ_CONTROL_EQ_STAGE1_2);
    initialize_channel_eq(CPU_GPU_0_3_ADDR_I2C, CHANNEL_2_REGISTER, EQ_CONTROL_EQ_STAGE1_2);
    initialize_channel_eq(CPU_GPU_0_3_ADDR_I2C, CHANNEL_3_REGISTER, EQ_CONTROL_EQ_STAGE1_2);
    initialize_channel_eq(CPU_GPU_4_7_ADDR_I2C, CHANNEL_4_REGISTER, EQ_CONTROL_EQ_STAGE1_2);
    initialize_channel_eq(CPU_GPU_4_7_ADDR_I2C, CHANNEL_5_REGISTER, EQ_CONTROL_EQ_STAGE1_2);
    initialize_channel_eq(CPU_GPU_4_7_ADDR_I2C, CHANNEL_6_REGISTER, EQ_CONTROL_EQ_STAGE1_2);
    initialize_channel_eq(CPU_GPU_4_7_ADDR_I2C, CHANNEL_7_REGISTER, EQ_CONTROL_EQ_STAGE1_2);
    ...
    initialize_channel_eq_profile(CPU_GPU_0_3_ADDR_I2C, CHANNEL_0_REGISTER, EQ_PROFILE_1 | FLAT_GAIN_0 | FLAT_GAIN_2);
    initialize_channel_eq_profile(CPU_GPU_0_3_ADDR_I2C, CHANNEL_1_REGISTER, EQ_PROFILE_1 | FLAT_GAIN_0 | FLAT_GAIN_2);
    initialize_channel_eq_profile(CPU_GPU_0_3_ADDR_I2C, CHANNEL_2_REGISTER, EQ_PROFILE_1 | FLAT_GAIN_0 | FLAT_GAIN_2);
    initialize_channel_eq_profile(CPU_GPU_0_3_ADDR_I2C, CHANNEL_3_REGISTER, EQ_PROFILE_1 | FLAT_GAIN_0 | FLAT_GAIN_2);
    initialize_channel_eq_profile(CPU_GPU_4_7_ADDR_I2C, CHANNEL_4_REGISTER, EQ_PROFILE_1 | FLAT_GAIN_0 | FLAT_GAIN_2);
    initialize_channel_eq_profile(CPU_GPU_4_7_ADDR_I2C, CHANNEL_5_REGISTER, EQ_PROFILE_1 | FLAT_GAIN_0 | FLAT_GAIN_2);
    initialize_channel_eq_profile(CPU_GPU_4_7_ADDR_I2C, CHANNEL_6_REGISTER, EQ_PROFILE_1 | FLAT_GAIN_0 | FLAT_GAIN_2);
    initialize_channel_eq_profile(CPU_GPU_4_7_ADDR_I2C, CHANNEL_7_REGISTER, EQ_PROFILE_1 | FLAT_GAIN_0 | FLAT_GAIN_2);
}

...
static ramp_channel_t ramp_channels[] = {
    ...
    { GPU_CPU_4_7_ADDR_I2C, CHANNEL_6_REGISTER, CHANNEL_ENABLED, EQ_LEVEL_0,  EQ_LEVEL_0, FLAT_GAIN_LEVEL_3, FLAT_GAIN_LEVEL_0, BIAS_LEVEL_3, BIAS_LEVEL_3, RAMP_STEP_MS, 7 * RAMP_STAGGER_MS },

...
static void initialize_gpu_cpu_redriver_running()
{
    ...
    initialize_channel_eq(GPU_CPU_4_7_ADDR_I2C, CHANNEL_4_REGISTER, EQ_CONTROL_EQ_STAGE1_INDEX_2 | EQ_CONTROL_EQ_STAGE2_INDEX_1 | EQ_CONTROL_EQ_STAGE1_BYPASS);
    initialize_channel_eq(GPU_CPU_4_7_ADDR_I2C, CHANNEL_5_REGISTER, EQ_CONTROL_EQ_STAGE1_INDEX_2 | EQ_CONTROL_EQ_STAGE2_INDEX_1 | EQ_CONTROL_EQ_STAGE1_BYPASS);
    initialize_channel_eq(GPU_CPU_4_7_ADDR_I2C, CHANNEL_6_REGISTER, EQ_CONTROL_EQ_STAGE1_INDEX_7 | EQ_CONTROL_EQ_STAGE2_INDEX_8);
    initialize_channel_eq(GPU_CPU_4_7_ADDR_I2C, CHANNEL_7_REGISTER, EQ_CONTROL_EQ_STAGE1_INDEX_2 | EQ_CONTROL_EQ_STAGE2_INDEX_1 | EQ_CONTROL_EQ_STAGE1_BYPASS);
    ...
    initialize_channel_eq_profile(GPU_CPU_4_7_ADDR_I2C, CHANNEL_4_REGISTER, EQ_PROFILE_INDEX_1);
    ...
    initialize_channel_eq_profile(GPU_CPU_4_7_ADDR_I2C, CHANNEL_7_REGISTER, EQ_PROFILE_INDEX_1);
}

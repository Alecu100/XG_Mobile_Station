...
static ramp_channel_t ramp_channels[] = {
    { GPU_CPU_0_3_ADDR_I2C, CHANNEL_0_REGISTER, CHANNEL_ENABLED, EQ_LEVEL_19, EQ_LEVEL_0, FLAT_GAIN_LEVEL_0, FLAT_GAIN_LEVEL_0, BIAS_LEVEL_1, BIAS_LEVEL_7, RAMP_STEP_MS, 0 * RAMP_STAGGER_MS },
    { GPU_CPU_0_3_ADDR_I2C, CHANNEL_1_REGISTER, CHANNEL_ENABLED, EQ_LEVEL_19, EQ_LEVEL_0, FLAT_GAIN_LEVEL_0, FLAT_GAIN_LEVEL_0, BIAS_LEVEL_1, BIAS_LEVEL_7, RAMP_STEP_MS, 1 * RAMP_STAGGER_MS },
    { GPU_CPU_0_3_ADDR_I2C, CHANNEL_2_REGISTER, CHANNEL_ENABLED, EQ_LEVEL_19, EQ_LEVEL_0, FLAT_GAIN_LEVEL_0, FLAT_GAIN_LEVEL_0, BIAS_LEVEL_1, BIAS_LEVEL_7, RAMP_STEP_MS, 2 * RAMP_STAGGER_MS },
    { GPU_CPU_0_3_ADDR_I2C, CHANNEL_3_REGISTER, CHANNEL_ENABLED, EQ_LEVEL_19, EQ_LEVEL_0, FLAT_GAIN_LEVEL_0, FLAT_GAIN_LEVEL_0, BIAS_LEVEL_1, BIAS_LEVEL_7, RAMP_STEP_MS, 3 * RAMP_STAGGER_MS },
    { GPU_CPU_4_7_ADDR_I2C, CHANNEL_4_REGISTER, CHANNEL_ENABLED, EQ_LEVEL_19,  EQ_LEVEL_0, FLAT_GAIN_LEVEL_0, FLAT_GAIN_LEVEL_0, BIAS_LEVEL_1, BIAS_LEVEL_7, RAMP_STEP_MS, 4 * RAMP_STAGGER_MS },
    { GPU_CPU_4_7_ADDR_I2C, CHANNEL_5_REGISTER, CHANNEL_ENABLED, EQ_LEVEL_19,  EQ_LEVEL_0, FLAT_GAIN_LEVEL_0, FLAT_GAIN_LEVEL_0, BIAS_LEVEL_1, BIAS_LEVEL_7, RAMP_STEP_MS, 5 * RAMP_STAGGER_MS },
    { GPU_CPU_4_7_ADDR_I2C, CHANNEL_6_REGISTER, CHANNEL_ENABLED, EQ_LEVEL_0,  EQ_LEVEL_0, FLAT_GAIN_LEVEL_0, FLAT_GAIN_LEVEL_0, BIAS_LEVEL_5, BIAS_LEVEL_5, RAMP_STEP_MS, 7 * RAMP_STAGGER_MS },
    { GPU_CPU_4_7_ADDR_I2C, CHANNEL_7_REGISTER, CHANNEL_ENABLED, EQ_LEVEL_19,  EQ_LEVEL_0, FLAT_GAIN_LEVEL_0, FLAT_GAIN_LEVEL_0, BIAS_LEVEL_1, BIAS_LEVEL_7, RAMP_STEP_MS, 6 * RAMP_STAGGER_MS },
    ...
    { CPU_GPU_4_7_ADDR_I2C, CHANNEL_4_REGISTER, CHANNEL_ENABLED, EQ_LEVEL_7, EQ_LEVEL_7, FLAT_GAIN_LEVEL_5, FLAT_GAIN_LEVEL_5, BIAS_LEVEL_1, BIAS_LEVEL_1, RAMP_STEP_MS, 4 * RAMP_STAGGER_MS },
    { CPU_GPU_4_7_ADDR_I2C, CHANNEL_5_REGISTER, CHANNEL_ENABLED, EQ_LEVEL_7, EQ_LEVEL_7, FLAT_GAIN_LEVEL_5, FLAT_GAIN_LEVEL_5, BIAS_LEVEL_1, BIAS_LEVEL_1, RAMP_STEP_MS, 5 * RAMP_STAGGER_MS },
    { CPU_GPU_4_7_ADDR_I2C, CHANNEL_6_REGISTER, CHANNEL_ENABLED, EQ_LEVEL_7, EQ_LEVEL_7, FLAT_GAIN_LEVEL_5, FLAT_GAIN_LEVEL_5, BIAS_LEVEL_1, BIAS_LEVEL_1, RAMP_STEP_MS, 7 * RAMP_STAGGER_MS },
    { CPU_GPU_4_7_ADDR_I2C, CHANNEL_7_REGISTER, CHANNEL_ENABLED, EQ_LEVEL_7, EQ_LEVEL_7, FLAT_GAIN_LEVEL_5, FLAT_GAIN_LEVEL_5, BIAS_LEVEL_1, BIAS_LEVEL_1, RAMP_STEP_MS, 6 * RAMP_STAGGER_MS },
};
